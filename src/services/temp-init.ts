...
// import { collectAllTreeIds, insertNodeInTree, removeNodeAndReturn } from '_utils/tree'
...
//         const { groupTitle, template } = data.properties[multifieldId] as MultifieldComponentSchema['properties']
...
//     source: $componentsData,
//     fn: (data, { groupId }) => {
//         const { tree: finalTree, node: removedNode } = removeNodeAndReturn(data.tree, groupId)
