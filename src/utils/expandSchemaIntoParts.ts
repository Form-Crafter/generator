...
export const expandSchemaIntoParts = (
  schemaComponents: ComponentSchemaOptionalId[]
) => {
  ...
  const generateTreeAndFillData = (
    parentId: TreeNode['parentId'],
    components: Parameters<typeof expandSchemaIntoParts>[0]
  ): ComponentsTree => {
